...
export const i18n = {
    ...
    RectSelect: {
        Title: () => t('RectSelect.Title'),
        Select: () => t('RectSelect.Select'),
        Stamp: () => t('RectSelect.Stamp'),
        Parts: () => t('RectSelect.Parts'),
        Mirror: () => t('RectSelect.Mirror'),
        Copy: () => t('RectSelect.Copy'),
        Paste: () => t('RectSelect.Paste'),
        Cut: () => t('RectSelect.Cut'),
        Delete: () => t('RectSelect.Delete'),
        Pin: () => t('RectSelect.Pin'),
        Unpin: () => t('RectSelect.Unpin'),
        BlackTransparent: () => t('RectSelect.BlackTransparent'),
        Commit: () => t('RectSelect.Commit'),
        Cancel: () => t('RectSelect.Cancel'),
        NoParts: () => t('RectSelect.NoParts'),
        SpawnAsParts: () => t('RectSelect.SpawnAsParts'),
        CloseMenu: () => t('RectSelect.CloseMenu'),
    },
    ColdClear: {
