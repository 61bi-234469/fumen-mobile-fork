export const resources = {
    ...
    Replay: {
        ...
        Select: {
            SelfPlayer: 'Your side',
            Rounds: 'Rounds',
            Start: 'Play this round',
            Win: 'Win',
            Lose: 'Loss',
            Unplayable: 'Not reproducible',
            RoundStats: '{{locks}} pieces / {{seconds}}s',
            ParseTime: 'parsed in {{ms}}ms',
        },
        Playing: {
            LockLabel: 'Piece',
            Terminal: 'End',
            Hold: 'HOLD',
            Next: 'NEXT',
            ClipNotice: 'Top {{count}} row(s) clipped',
            ...
            Basis: 'Step by',
            Timeline: 'Timeline',
            LockEndpoints: 'Lock first and last jump',
            UnlockEndpoints: 'Unlock first and last jump',
            Gauge: 'Garbage gauge',
            RiseRow: 'Rise row',
            RiseRowMore: 'Rise row (+{{more}})',
            GarbageTank: '↓{{rows}} tanked',
            GarbageCancel: '✕{{rows}} cancelled',
            GarbageReceive: '☢{{rows}} received',
            Killer: 'Cause of loss',
            KillerGarbage: 'attack at {{time}}, {{rows}} row(s), column {{column}}',
            KillerSeek: 'Go to that moment',
        },
        Analysis: {
            Title: 'AI analysis (Cold Clear)',
            Start: 'Analyze this round',
            Reanalyze: 'Analyze again',
            Abort: 'Stop',
            ThinkMs: 'Think time per move',
            ThinkMsOption: '{{ms}}ms',
            Estimate: '{{moves}} moves / about {{seconds}}s',
            Progress: 'Analyzing... {{current}} / {{total}}',
            Graph: 'Move evaluation graph',
            MatchRate: 'Match {{percent}}%',
            MeanLoss: 'Mean loss {{loss}}',
            MaxLoss: 'Max loss {{loss}}',
            Unmatched: 'Off-list {{count}}',
            Skipped: 'Skipped {{count}}',
            Worst: 'Biggest losses',
            WorstItem: '#{{index}} −{{loss}}',
            CurrentBest: 'Best move',
            CurrentLoss: 'Loss {{loss}} / rank {{rank}}',
            CurrentUnmatched: 'Off-list (not among the AI candidates)',
            CurrentSkipped: 'Position not analyzed',
            CurrentPending: 'Not analyzed yet',
            Aborted: 'Analysis stopped',
            Failed: 'Analysis failed',
            Note: 'Taller bars mean a bigger gap from the best move. Losses are relative within this round, and the search is time-capped.',
        },
        Error: {
    ...
    ColdClear: {
        ...
        ReplayAnalysisRunning: 'AI: Not available while the replay analysis is running',
